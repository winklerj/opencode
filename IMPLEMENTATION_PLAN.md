...
| 2026-01-14 | Skills API completion | complete | Added missing Skills API endpoints: POST /skills (create), PUT /skills/:name (update), DELETE /skills/:name (delete), POST /skills/:name/invoke (invoke skill in session context); integrated Plugin.trigger for skill.invoke.before/after hooks |
